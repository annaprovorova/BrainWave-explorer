...
from Analyse import calc_fft, ica_preproc_first_5_sec, ica_preproc_last_5_sec
...
if __name__ == '__main__':
    ...
    layout = [
        ...
        [sg.Submit('Построить график', key='-PLOT-', disabled=True), sg.Submit('Выгрузить общий отчёт(5 сек в начале)', key='-REPS-', disabled=True), sg.Submit('Выгрузить общий отчёт(5 сек в конце)', key='-REPF-', disabled=True)],
